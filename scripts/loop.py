...
def main(
    ...
    batch_size: int = typer.Option(16, help="Batch size for the dataloader"),
    num_workers: int = typer.Option(8, help="Number of workers for the dataloader"),
